...
namespace flecs {
    ...
    public:
         ...
         *         have the component.
         */
        void* get(flecs::entity component) const {
            ecs_assert(m_world != NULL, ECS_INVALID_PARAMETER, NULL);
            ecs_assert(m_id != 0, ECS_INVALID_PARAMETER, NULL);
         ...
         *         have the component.
         */
        void* get(entity_t component_id) const {
            ecs_assert(m_world != NULL, ECS_INVALID_PARAMETER, NULL);
            ecs_assert(m_id != 0, ECS_INVALID_PARAMETER, NULL);
        ...
        const T* get_trait(flecs::entity component) const {
            ...
            return static_cast<T*>(ecs_get_w_entity(m_world, m_id, ecs_trait(
        ...
        const C* get_trait_tag(flecs::entity trait) const {
            ...
            return static_cast<C*>(ecs_get_w_entity(m_world, m_id, ecs_trait(
                comp_id, trait.id())));
        }
