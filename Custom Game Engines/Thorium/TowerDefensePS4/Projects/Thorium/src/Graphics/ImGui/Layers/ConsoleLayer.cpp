...
namespace Th
{
	ConsoleLayer::ConsoleLayer()
	{
        ...
        EventMessenger::GetInstance().ConnectListener<const std::string&>("ConsoleMessage",&Th::ConsoleLayer::RecieveMessage,this);
	}
	...
	void ConsoleLayer::AddLog(const char* fmt, ...)
	{
        // FIXME-OPT
        char buf[1024];
        va_list args;
	...
	void ConsoleLayer::Draw(const char* title, bool* p_open)
	{
	...
	void ConsoleLayer::ExecCommand(const char* command_line)
	{
        AddLog("# %s\n", command_line);
	...
	void ConsoleLayer::RecieveMessage(const std::string& message)
	{
